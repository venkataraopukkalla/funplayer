...
public class AlbumUIMusicPlayDesign extends AppCompatActivity implements  MusicFunctionality {
    ...
    MusicPlayDesign musicPlayDesign;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_album_uimusic_play_design);
        ...
        // Dynamically set Ad Unit ID (from Firebase Remote Config or elsewhere)
        ...
        keyValue= (ArrayList<SongsDetails>) getIntent().getSerializableExtra("ALBUM_UI_KEY");
        songNumber=(Integer) getIntent().getSerializableExtra("ALBUM_UI_SONG_NO_KEY");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Log.i("keepsmile",songNumber+"");
         MyMusic.currentSongNumber=songNumber;
    }
